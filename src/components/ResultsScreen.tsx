  ...
  return (
      ...
      <div className="max-w-md mx-auto px-4 py-8">
        <header className="flex items-center mb-6">
          <Button variant="ghost" className="p-0 mr-4">
            <ArrowLeft className="h-6 w-6" onClick={handleGoBack}></ArrowLeft>
          </Button>
    ...
    <CardContent className="p-4 flex flex-col items-center">
      <div className="text-blue-500 mb-2" style={{color: '#3B82F6'}}>
          ...
          <div className="text-4xl font-bold text-blue-600" style={{color: '#2563EB'}}>3</div>
      <p className="text-sm text-blue-600" style={{color: '#2563EB'}}>Low</p>
            </CardContent>
          </Card>
